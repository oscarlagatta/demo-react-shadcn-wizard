      ...
      <div className="space-y-4 lg:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-6 gap-4 lg:gap-6">
          <UserSearchField
            ...
            placeholder="Search for APS Support Manager..."
            tooltip="Application Production Support Manager responsible for overall support"
          ...
          <UserSearchField
            ...
            label="APS Technical Lead"
            placeholder="Search for APS Technical Lead..."
            tooltip="Technical lead for Application Production Support"
            isEditMode={isEditMode}
            initialUserId={form.getValues("apsTechnicalLead")}
            className="2xl:col-span-2"
          />
      ...
      <div className="mt-6 lg:mt-8 p-4 lg:p-6 bg-purple-50 border border-purple-200 rounded-lg">
        ...
        <div className="mt-4 pt-4 border-t border-purple-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-2 text-xs lg:text-sm">
            <div>
              <span className="font-medium text-purple-700">APS Manager:</span>{" "}
              <span className="text-purple-600 break-words">{watchedValues.apsSupport || "Not assigned"}</span>
            </div>
            <div>
              <span className="font-medium text-purple-700">Technical Lead:</span>{" "}
              <span className="text-purple-600 break-words">{watchedValues.apsTechnicalLead || "Not assigned"}</span>
            </div>
            <div>
              <span className="text-purple-600 break-words">
